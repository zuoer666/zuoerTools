...
public class MyHttpUtilBase64 {

	static Base64.Decoder decoder = Base64.getDecoder();
	static String decoderBase64String="";
		...
		try {  
			...
			if (result.getStatusLine().getStatusCode() == HttpStatus.SC_OK) {  
				try {  
					...
					decoderBase64String =new String(decoder.decode(str ), "UTF-8");
					//把json字符串转换成json对象   
					jsonResult = JSONObject.parseObject(decoderBase64String);  
				} catch (Exception e) {  
	...
	public static JSONObject requestByGetJson(String url) {  
		...
		try {  
			...
			if (response.getStatusLine().getStatusCode() == HttpStatus.SC_OK) {  
				...
				decoderBase64String =new String(decoder.decode(strResult), "UTF-8");
				//把json字符串转换成json对象  
				jsonResult = JSONObject.parseObject(decoderBase64String);  
			} else {  
